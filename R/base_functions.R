...
var_ind = function(data_mini) {
	...
	return(cbind(1,as.matrix(output), data_mini$Income[1] < 0, data_mini$Income[1] < 1 & data_mini$Income[1] >= 0, data_mini$Income[1] >= 1 & data_mini$Income[1] < 2, data_mini$Income[1] >= 2))
}
